...
class CodesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create code" do
    assert_difference("Code.count") do
      post codes_url, params: { code: { code_text: @code.code_text, description: @code.description } }
    end
  ...
  test "should update code" do
    patch code_url(@code), params: { code: { code_text: @code.code_text, description: @code.description } }
